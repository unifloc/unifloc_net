...
Module u7_Excel_functions_PVT
    ...
    Public Function PVT_bg_m3m3(
                ...
                ByVal t_C As Double,
                Optional ByVal gamma_gas As Double = const_gg_,
                Optional ByVal gamma_oil As Double = const_go_,
                Optional ByVal gamma_wat As Double = const_gw_,
                Optional ByVal rsb_m3m3 As Double = const_rsb_default,
                Optional ByVal rp_m3m3 As Double = -1,
                Optional ByVal pb_atma As Double = -1,
                Optional ByVal tres_C As Double = const_tres_default,
        ...
        Catch ex As Exception
            PVT_bg_m3m3 = -1
            AddLogMsg("Error:PVT_bg_m3m3:" & ex.Message)
    ...
    Private Function ReadPVT(Optional ByVal gamma_gas As Double = const_gg_,
                    Optional ByVal gamma_oil As Double = const_go_,
                    Optional ByVal gamma_wat As Double = const_gw_,
                    Optional ByVal rsb_m3m3 As Double = const_rsb_default,
                    Optional ByVal rp_m3m3 As Double = -1,
